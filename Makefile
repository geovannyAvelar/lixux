...
qemu:
	riscv64-unknown-linux-gnu-gcc -g -ffreestanding -nostartfiles -nostdlib -nodefaultlibs -O0 -Wl,--gc-sections -c -mcmodel=medany kernel.c -o kernel.o
	riscv64-unknown-elf-as -c entry.s -o entry.o
	riscv64-unknown-elf-as -c uart.s -o uart.o
	riscv64-unknown-elf-ld -T linker.ld -nostdlib kernel.o entry.o uart.o -o kernel.elf
